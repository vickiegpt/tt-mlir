...
struct TTIRToTTIRDecompositionPass
  ...
  // The base class generated by TableGen should provide:
  // - opsToDecompose member variable
  // - getContext(), getOperation(), signalPassFailure() methods
  // - runOnOperation() as a virtual function
